...
const AccountPage = () => {
  ...
  if (userLoading || companyLoading)
    return <p className="text-center my-5">Loading User Data...</p>;

  if (userError)
    return (
      <p className="text-center my-5">
        Error loading User Data: <em>{userError.message}</em>
      </p>
    );
  ...
  if (companyError)
    return (
      <p className="text-center my-5">
        Error loading Company Data: <em>{companyError.message}</em>
      </p>
    );
