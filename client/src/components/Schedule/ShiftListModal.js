          ...
          {shifts.map((shift) => (
            <div key={shift._id}>
              ...
              <p>
                ...
                {shift.position ? shift.position.jobTitle : "N/A"}
              </p>
              <p>
                <strong>Start:</strong>{" "}
                {moment(shift.startDateTime).format("ddd, MMM D, YYYY h:mm A")}
              </p>
              <p>
                <strong>End:</strong>{" "}
                {moment(shift.endDateTime).format("ddd, MMM D, YYYY h:mm A")}
              </p>
              <p>
                <strong>Note:</strong> {shift.note}
              </p>
              <p>
