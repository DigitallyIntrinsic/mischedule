  ...
  return (
    <div className="container my-5" style={{ width: "70%" }}>
      ...
      <div className="container text-center">
        <p>
          <em>
            User profile codes can be obtained from Admin users who have already
            created a profile for you!
            <br />
            Please reach out to your account administrator to receive your user
            ID.
          </em>
        </p>
      </div>
